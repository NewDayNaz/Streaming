    ...
    stageLayoutList.forEach(
        function (layout) {
            ...
            if (layout.uid == uid) {
                ...
                console.log('displayStageLayout A', uid, layout);
                ...
                layout.fme.forEach(
                    function (frame) {
                        ...
                        console.log('displayStageLayout B', uid, frame);
